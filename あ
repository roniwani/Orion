...
local OrionLib = {
	...
	Themes = {
		Default = {
	Main = Color3.fromRGB(14, 14, 18),        -- 宇宙ブラック
	Second = Color3.fromRGB(22, 22, 30),      -- 星雲ダーク
	Stroke = Color3.fromRGB(70, 80, 95),      -- クールグレー（OFF）
	Divider = Color3.fromRGB(45, 55, 70),     -- 仕切り用ダークブルー
	Text = Color3.fromRGB(235, 235, 235),     -- 高可読ホワイト
	TextDark = Color3.fromRGB(160, 170, 180)  -- OFFテキスト
}
	},
	...
	function TabFunction:MakeTab(TabConfig)
		...
		local function GetElements(ItemParent)
			...
			function ElementFunction:AddToggle(ToggleConfig)
				...
				ToggleConfig.Color = ToggleConfig.Color or Color3.fromRGB(255, 170, 60)
			...
			function ElementFunction:AddSlider(SliderConfig)
				...
				SliderConfig.Color = SliderConfig.Color or Color3.fromRGB(255, 170, 60)
